...
function submitOrder(){
  ...
  if($('#payment_list label input[type="radio"]:checked').parent().siblings().hasClass('banklist')){
      banklist = $('#payment_list label input[type="radio"]:checked').parent().parent().find(".banklist input[name='bank']:checked").val();
  }
  ...
  form.find('input[name="banklist"]').val(banklist)
