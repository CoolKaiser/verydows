...
<div class="content">
  ...
  <div class="doacts">
      <a class="ae add btn" href="<?php echo url(array('m'=>$MOD, 'c'=>'payment_method', 'a'=>'add', ));?>"><i></i><font>新增支付方式</font></a>
      <a class="ae btn" onclick="doslvent('<?php echo url(array('m'=>$MOD, 'c'=>'payment_method', 'a'=>'edit', ));?>', 'id')"><i class="edit"></i><font>编辑</font></a>
      <a class="ae btn" onclick="doslvent('<?php echo url(array('m'=>$MOD, 'c'=>'payment_method', 'a'=>'delete', ));?>','id')"><i class="remove"></i><font>删除</font></a>
    </div>
  <div class="box">
